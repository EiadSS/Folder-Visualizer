...
class Visualiser:
    ...
    def run_visualisation(self, tree: TMTree) -> None:
        ...
        self.render_display()
        tree.update_rectangles(
            (0, 0, self.width, self.height - self.font_height))
    ...
    def render_display(self) -> None:
        ...
        try:
            subscreen = self.screen.subsurface(
                (0, 0, self.width, self.height - self.font_height))
        except ValueError:
            return
        ...
        if self.selected_node is not None:
            pygame.draw.rect(subscreen, (255, 255, 255),
                             self.selected_node.rect, 4)
        if self.hover_node is not None:
            pygame.draw.rect(subscreen, (255, 255, 255), self.hover_node.rect,
                             2)
    ...
    def _render_text(self) -> None:
        ...
        text_surface = font.render(self._get_display_text(), True,
                                   pygame.Color('white'))
        ...
        while True:
            ...
            if event.type == pygame.MOUSEBUTTONUP:
                ...
                if k == pygame.K_UP:
                    ...
                    self.tree.update_rectangles(
                        (0, 0, self.width, drawable_height))
...
def run_treemap_file_system(path: str) -> None:
    ...
    instructions = '\n==== Instructions for use ====\n' \
                   'When a folder/file is selected, the following keys can be ' \
                   '\ pressed:\n' \
                   ...
                   '"Up" and "Down" arrow keys to change the size of a file (' \
                   'in visualization)\n' \
                   '"M" to move a file (while selecting a file and hovering ' \
                   'over a folder)\n' \
...
if __name__ == '__main__':
    ...
    PATH_TO_VISUALISE = '/Users/Tala/Desktop/csc148/assignments/a2 ' \
                        'summer/starter_code/example-directory'  # enter a
    # custom path here if you wish
